...
export default {
  ...
  bottomBar: {
    ...
    syncEvidenceCapture: 'Sync Evidence Capture',
    record: 'Start capture',
    stopRecord: 'Stop capture',
    copy: 'Copy',
    export: 'Export',
    agent: 'Agent',
    mcp: 'MCP',
  ...
  overview: {
    ...
    ingress: {
      ...
      dns: 'DNS Resolution',
      nginx: 'Nginx Options',
      architectureHint: 'Public traffic reaches reverse proxy nodes first, so DNS record values point to proxy-node public IPs; nginx then forwards to upstream backends over private addresses.',

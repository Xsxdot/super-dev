...
<template>
  <div class="settings-shell">
    <aside class="settings-sidebar settings-nav" data-test="settings-sidebar">
      ...
      <button
        data-test="settings-tab-debug-browser"
        class="settings-nav-item"
        :class="{ active: selectedTab === 'debugBrowser' }"
        @click="selectedTab = 'debugBrowser'"
      >
        <svg width="13" height="13" viewBox="0 0 16 16" fill="none" style="vertical-align:middle;margin-right:5px">
          <rect x="2.5" y="3" width="11" height="9" rx="1" stroke="currentColor" stroke-width="1.4" fill="none"/>
          <path d="M2.5 5.8h11" stroke="currentColor" stroke-width="1.3"/>
          <path d="M4.3 4.4h.01M6 4.4h.01" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/>
        </svg>
        {{ t('settings.tabs.debugBrowser') }}
      </button>
      <button
    ...
    <main class="settings-main">
      ...
      <section v-else-if="selectedTab === 'debugBrowser'" class="settings-pane">
        <DebugBrowserTab />
      </section>
